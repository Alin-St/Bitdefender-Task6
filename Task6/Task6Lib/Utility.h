...
public:
	...
	static bool runProgramOnStartup(const wchar_t* appName, const wchar_t* appPath, bool currentUser = true, bool onlyOnce = false, bool* pathMatches = nullptr);
	...
	static bool stopRunningProgramOnStartup(const wchar_t* appName, const wchar_t* appPath = nullptr, bool currentUser = true, bool stopOneTimeRun = false);
};